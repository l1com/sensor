...
// ==============================================================
`timescale 1ns/1ps
module edgetracing_accel_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER            = 6'h08,
    ADDR_ISR            = 6'h0c,
    ADDR_IMG_INP_DATA_0 = 6'h10,
    ADDR_IMG_INP_DATA_1 = 6'h14,
    ADDR_IMG_INP_CTRL   = 6'h18,
    ADDR_IMG_OUT_DATA_0 = 6'h1c,
    ADDR_IMG_OUT_DATA_1 = 6'h20,
    ADDR_IMG_OUT_CTRL   = 6'h24,
    ADDR_ROWS_DATA_0    = 6'h28,
    ADDR_ROWS_CTRL      = 6'h2c,
    ADDR_COLS_DATA_0    = 6'h30,
    ADDR_COLS_CTRL      = 6'h34,
    WRIDLE              = 2'd0,
    WRDATA              = 2'd1,
    WRRESP              = 2'd2,
    WRRESET             = 2'd3,
