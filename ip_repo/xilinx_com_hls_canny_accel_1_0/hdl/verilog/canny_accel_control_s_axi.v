...
// ==============================================================
`timescale 1ns/1ps
module canny_accel_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER                   = 7'h08,
    ADDR_ISR                   = 7'h0c,
    ADDR_IMG_INP_DATA_0        = 7'h10,
    ADDR_IMG_INP_DATA_1        = 7'h14,
    ADDR_IMG_INP_CTRL          = 7'h18,
    ADDR_IMG_OUT_DATA_0        = 7'h1c,
    ADDR_IMG_OUT_DATA_1        = 7'h20,
    ADDR_IMG_OUT_CTRL          = 7'h24,
    ADDR_ROWS_DATA_0           = 7'h28,
    ADDR_ROWS_CTRL             = 7'h2c,
    ADDR_COLS_DATA_0           = 7'h30,
    ADDR_COLS_CTRL             = 7'h34,
    ADDR_LOW_THRESHOLD_DATA_0  = 7'h38,
    ADDR_LOW_THRESHOLD_CTRL    = 7'h3c,
    ADDR_HIGH_THRESHOLD_DATA_0 = 7'h40,
    ADDR_HIGH_THRESHOLD_CTRL   = 7'h44,
    WRIDLE                     = 2'd0,
    WRDATA                     = 2'd1,
    WRRESP                     = 2'd2,
    WRRESET                    = 2'd3,
