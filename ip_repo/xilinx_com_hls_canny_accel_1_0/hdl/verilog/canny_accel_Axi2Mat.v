...
wire   [31:0] Axi2AxiStream_U0_rows_out_din;
wire    Axi2AxiStream_U0_rows_out_write;
wire   [31:0] Axi2AxiStream_U0_cols_out_din;
wire    Axi2AxiStream_U0_cols_out_write;
wire    AxiStream2Mat_U0_ldata1_read;
wire   [63:0] AxiStream2Mat_U0_in_mat_421_din;
wire    AxiStream2Mat_U0_in_mat_421_write;
...
wire    AxiStream2Mat_U0_start_full_n;
...
canny_accel_fifo_w32_d2_S_x rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
canny_accel_fifo_w32_d2_S_x cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign AxiStream2Mat_U0_start_full_n = 1'b1;

assign AxiStream2Mat_U0_start_write = 1'b0;
...
assign ap_sync_done = AxiStream2Mat_U0_ap_done;

assign ap_sync_ready = Axi2AxiStream_U0_ap_ready;

assign in_mat_421_din = AxiStream2Mat_U0_in_mat_421_din;

assign in_mat_421_write = AxiStream2Mat_U0_in_mat_421_write;
