...
entity canny_accel_control_s_axi is
generic (
...
end entity canny_accel_control_s_axi;
...
architecture behave of canny_accel_control_s_axi is
    ...
    constant ADDR_IMG_OUT_DATA_0        : INTEGER := 16#1c#;
    constant ADDR_IMG_OUT_DATA_1        : INTEGER := 16#20#;
    constant ADDR_IMG_OUT_CTRL          : INTEGER := 16#24#;
    constant ADDR_ROWS_DATA_0           : INTEGER := 16#28#;
    constant ADDR_ROWS_CTRL             : INTEGER := 16#2c#;
    constant ADDR_COLS_DATA_0           : INTEGER := 16#30#;
    constant ADDR_COLS_CTRL             : INTEGER := 16#34#;
    constant ADDR_LOW_THRESHOLD_DATA_0  : INTEGER := 16#38#;
    constant ADDR_LOW_THRESHOLD_CTRL    : INTEGER := 16#3c#;
    constant ADDR_HIGH_THRESHOLD_DATA_0 : INTEGER := 16#40#;
    constant ADDR_HIGH_THRESHOLD_CTRL   : INTEGER := 16#44#;
