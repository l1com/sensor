...
architecture behav of canny_accel_Axi2Mat is 
...
attribute shreg_extract : string;
    ...
    signal Axi2AxiStream_U0_m_axi_gmem1_AWVALID : STD_LOGIC;
    signal Axi2AxiStream_U0_m_axi_gmem1_AWADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_AWID : STD_LOGIC_VECTOR (0 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_AWLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_AWSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_AWBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_AWLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_AWCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_AWPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_AWQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_AWREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_AWUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_WVALID : STD_LOGIC;
    signal Axi2AxiStream_U0_m_axi_gmem1_WDATA : STD_LOGIC_VECTOR (63 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_WSTRB : STD_LOGIC_VECTOR (7 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_WLAST : STD_LOGIC;
    signal Axi2AxiStream_U0_m_axi_gmem1_WID : STD_LOGIC_VECTOR (0 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_WUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_ARVALID : STD_LOGIC;
    signal Axi2AxiStream_U0_m_axi_gmem1_ARADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_ARID : STD_LOGIC_VECTOR (0 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_ARLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_ARSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_ARBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_ARLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_ARCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_ARPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_ARQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_ARREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_ARUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_RREADY : STD_LOGIC;
    signal Axi2AxiStream_U0_m_axi_gmem1_BREADY : STD_LOGIC;
    signal Axi2AxiStream_U0_ldata_din : STD_LOGIC_VECTOR (63 downto 0);
    signal Axi2AxiStream_U0_ldata_write : STD_LOGIC;
    signal Axi2AxiStream_U0_rows_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Axi2AxiStream_U0_rows_out_write : STD_LOGIC;
    signal Axi2AxiStream_U0_cols_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Axi2AxiStream_U0_cols_out_write : STD_LOGIC;
    signal AxiStream2Mat_U0_ldata1_read : STD_LOGIC;
    signal AxiStream2Mat_U0_in_mat_421_din : STD_LOGIC_VECTOR (63 downto 0);
    signal AxiStream2Mat_U0_in_mat_421_write : STD_LOGIC;
    ...
    signal AxiStream2Mat_U0_start_full_n : STD_LOGIC;
    signal AxiStream2Mat_U0_start_write : STD_LOGIC;

    component canny_accel_Axi2AxiStream IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component canny_accel_AxiStream2Mat IS
    port (
    ...
    component canny_accel_fifo_w64_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component canny_accel_fifo_w32_d2_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component canny_accel_start_for_AxiStream2Mat_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    Axi2AxiStream_U0 : component canny_accel_Axi2AxiStream
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        rows => rows,
        cols => cols,
        rows_out_din => Axi2AxiStream_U0_rows_out_din,
        rows_out_full_n => rows_c_full_n,
        rows_out_write => Axi2AxiStream_U0_rows_out_write,
        cols_out_din => Axi2AxiStream_U0_cols_out_din,
        cols_out_full_n => cols_c_full_n,
        cols_out_write => Axi2AxiStream_U0_cols_out_write);

    AxiStream2Mat_U0 : component canny_accel_AxiStream2Mat
    port map (
        ldata1_dout => ldata_dout,
        ldata1_empty_n => ldata_empty_n,
        ldata1_read => AxiStream2Mat_U0_ldata1_read,
        in_mat_421_din => AxiStream2Mat_U0_in_mat_421_din,
        in_mat_421_full_n => in_mat_421_full_n,
        in_mat_421_write => AxiStream2Mat_U0_in_mat_421_write,
    ...
    ldata_U : component canny_accel_fifo_w64_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    rows_c_U : component canny_accel_fifo_w32_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Axi2AxiStream_U0_rows_out_din,
        if_full_n => rows_c_full_n,
        if_write => Axi2AxiStream_U0_rows_out_write,
        if_dout => rows_c_dout,
        if_empty_n => rows_c_empty_n,
        if_read => AxiStream2Mat_U0_rows_read);

    cols_c_U : component canny_accel_fifo_w32_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Axi2AxiStream_U0_cols_out_din,
        if_full_n => cols_c_full_n,
        if_write => Axi2AxiStream_U0_cols_out_write,
        if_dout => cols_c_dout,
        if_empty_n => cols_c_empty_n,
        if_read => AxiStream2Mat_U0_cols_read);

    start_for_AxiStream2Mat_U0_U : component canny_accel_start_for_AxiStream2Mat_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    AxiStream2Mat_U0_start_full_n <= ap_const_logic_1;
    AxiStream2Mat_U0_start_write <= ap_const_logic_0;
    ap_done <= AxiStream2Mat_U0_ap_done;
    ap_idle <= (AxiStream2Mat_U0_ap_idle and Axi2AxiStream_U0_ap_idle);
    ap_ready <= Axi2AxiStream_U0_ap_ready;
    ap_sync_continue <= ap_continue;
    ap_sync_done <= AxiStream2Mat_U0_ap_done;
    ap_sync_ready <= Axi2AxiStream_U0_ap_ready;
    in_mat_421_din <= AxiStream2Mat_U0_in_mat_421_din;
    in_mat_421_write <= AxiStream2Mat_U0_in_mat_421_write;
    m_axi_gmem1_ARADDR <= Axi2AxiStream_U0_m_axi_gmem1_ARADDR;
    m_axi_gmem1_ARBURST <= Axi2AxiStream_U0_m_axi_gmem1_ARBURST;
