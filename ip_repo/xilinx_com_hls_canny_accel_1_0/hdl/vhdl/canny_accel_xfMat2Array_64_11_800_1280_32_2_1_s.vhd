...
entity canny_accel_xfMat2Array_64_11_800_1280_32_2_1_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of canny_accel_xfMat2Array_64_11_800_1280_32_2_1_s is 
...
attribute shreg_extract : string;
    ...
    signal dstPtr_read_reg_80 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln1557_fu_75_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal trunc_ln1557_reg_85 : STD_LOGIC_VECTOR (15 downto 0);
    signal srcMat_cols_read_reg_90 : STD_LOGIC_VECTOR (10 downto 0);
    signal grp_Mat2Axi_fu_62_dst_mat_422_read : STD_LOGIC;
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_AWVALID : STD_LOGIC;
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_AWADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_AWID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_AWLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_AWSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_AWBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_AWLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_AWCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_AWPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_AWQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_AWREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_AWUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_WVALID : STD_LOGIC;
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_WDATA : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_WSTRB : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_WLAST : STD_LOGIC;
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_WID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_WUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_ARVALID : STD_LOGIC;
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_ARADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_ARID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_ARLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_ARSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_ARBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_ARLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_ARCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_ARPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_ARQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_ARREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_ARUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_RREADY : STD_LOGIC;
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_BREADY : STD_LOGIC;
    ...
    component canny_accel_Mat2Axi IS
    port (
        dst_mat_422_dout : IN STD_LOGIC_VECTOR (63 downto 0);
        dst_mat_422_empty_n : IN STD_LOGIC;
        dst_mat_422_read : OUT STD_LOGIC;
...
begin
    grp_Mat2Axi_fu_62 : component canny_accel_Mat2Axi
    port map (
        dst_mat_422_dout => dst_mat_422_dout,
        dst_mat_422_empty_n => dst_mat_422_empty_n,
        dst_mat_422_read => grp_Mat2Axi_fu_62_dst_mat_422_read,
        ...
        dout => dstPtr_read_reg_80,
        rows => trunc_ln1557_reg_85,
        cols => srcMat_cols_read_reg_90,
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((((ap_const_logic_1 = ap_CS_fsm_state2) and (ap_sync_grp_Mat2Axi_fu_62_ap_ready = ap_const_logic_0)) or (not(((dstPtr_empty_n = ap_const_logic_0) or (srcMat_cols_empty_n = ap_const_logic_0) or (srcMat_rows_empty_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                dstPtr_read_reg_80 <= dstPtr_dout;
                srcMat_cols_read_reg_90 <= srcMat_cols_dout;
                trunc_ln1557_reg_85 <= trunc_ln1557_fu_75_p1;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, srcMat_rows_empty_n, srcMat_cols_empty_n, dstPtr_empty_n, ap_CS_fsm_state2, ap_block_state2_on_subcall_done)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((dstPtr_empty_n = ap_const_logic_0) or (srcMat_cols_empty_n = ap_const_logic_0) or (srcMat_rows_empty_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
    ...
    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, srcMat_rows_empty_n, srcMat_cols_empty_n, dstPtr_empty_n)
    begin
                ap_block_state1 <= ((dstPtr_empty_n = ap_const_logic_0) or (srcMat_cols_empty_n = ap_const_logic_0) or (srcMat_rows_empty_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;


    ap_block_state1_ignore_call11_assign_proc : process(ap_start, ap_done_reg, srcMat_rows_empty_n, srcMat_cols_empty_n, dstPtr_empty_n)
    begin
                ap_block_state1_ignore_call11 <= ((dstPtr_empty_n = ap_const_logic_0) or (srcMat_cols_empty_n = ap_const_logic_0) or (srcMat_rows_empty_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;


    ap_block_state2_on_subcall_done_assign_proc : process(ap_sync_grp_Mat2Axi_fu_62_ap_ready, ap_sync_grp_Mat2Axi_fu_62_ap_done)
    begin
                ap_block_state2_on_subcall_done <= ((ap_sync_grp_Mat2Axi_fu_62_ap_ready and ap_sync_grp_Mat2Axi_fu_62_ap_done) = ap_const_logic_0);
    end process;
    ...
    dstPtr_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, srcMat_rows_empty_n, srcMat_cols_empty_n, dstPtr_empty_n)
    begin
        if ((not(((dstPtr_empty_n = ap_const_logic_0) or (srcMat_cols_empty_n = ap_const_logic_0) or (srcMat_rows_empty_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    dst_mat_422_read_assign_proc : process(grp_Mat2Axi_fu_62_dst_mat_422_read, ap_CS_fsm_state2)
    begin
    ...
    grp_Mat2Axi_fu_62_ap_continue_assign_proc : process(ap_CS_fsm_state2, ap_block_state2_on_subcall_done)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (ap_const_boolean_0 = ap_block_state2_on_subcall_done))) then 
    ...
    m_axi_gmem2_AWVALID_assign_proc : process(ap_CS_fsm_state1, grp_Mat2Axi_fu_62_m_axi_gmem2_AWVALID, ap_CS_fsm_state2)
    begin
    ...
    m_axi_gmem2_BREADY_assign_proc : process(ap_CS_fsm_state1, grp_Mat2Axi_fu_62_m_axi_gmem2_BREADY, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) or (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            m_axi_gmem2_BREADY <= grp_Mat2Axi_fu_62_m_axi_gmem2_BREADY;
        else 
    ...
    m_axi_gmem2_WVALID_assign_proc : process(ap_CS_fsm_state1, grp_Mat2Axi_fu_62_m_axi_gmem2_WVALID, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) or (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            m_axi_gmem2_WVALID <= grp_Mat2Axi_fu_62_m_axi_gmem2_WVALID;
        else 
    ...
    srcMat_cols_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, srcMat_rows_empty_n, srcMat_cols_empty_n, dstPtr_empty_n)
    begin
        if ((not(((dstPtr_empty_n = ap_const_logic_0) or (srcMat_cols_empty_n = ap_const_logic_0) or (srcMat_rows_empty_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    srcMat_rows_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, srcMat_rows_empty_n, srcMat_cols_empty_n, dstPtr_empty_n)
    begin
        if ((not(((dstPtr_empty_n = ap_const_logic_0) or (srcMat_cols_empty_n = ap_const_logic_0) or (srcMat_rows_empty_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    trunc_ln1557_fu_75_p1 <= srcMat_rows_dout(16 - 1 downto 0);
end behav;
