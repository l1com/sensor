...
architecture behav of canny_accel_Mat2Axi is 
...
attribute shreg_extract : string;
    signal Mat2Axi_entry67_U0_ap_start : STD_LOGIC;
    signal Mat2Axi_entry67_U0_start_full_n : STD_LOGIC;
    signal Mat2Axi_entry67_U0_ap_done : STD_LOGIC;
    signal Mat2Axi_entry67_U0_ap_continue : STD_LOGIC;
    signal Mat2Axi_entry67_U0_ap_idle : STD_LOGIC;
    signal Mat2Axi_entry67_U0_ap_ready : STD_LOGIC;
    signal Mat2Axi_entry67_U0_start_out : STD_LOGIC;
    signal Mat2Axi_entry67_U0_start_write : STD_LOGIC;
    signal Mat2Axi_entry67_U0_dout_out_din : STD_LOGIC_VECTOR (63 downto 0);
    signal Mat2Axi_entry67_U0_dout_out_write : STD_LOGIC;
    signal Mat2Axi_entry67_U0_rows_out_din : STD_LOGIC_VECTOR (15 downto 0);
    signal Mat2Axi_entry67_U0_rows_out_write : STD_LOGIC;
    signal Mat2Axi_entry67_U0_rows_out1_din : STD_LOGIC_VECTOR (15 downto 0);
    signal Mat2Axi_entry67_U0_rows_out1_write : STD_LOGIC;
    signal Mat2Axi_entry67_U0_cols_out_din : STD_LOGIC_VECTOR (10 downto 0);
    signal Mat2Axi_entry67_U0_cols_out_write : STD_LOGIC;
    signal Mat2Axi_entry67_U0_cols_out2_din : STD_LOGIC_VECTOR (10 downto 0);
    signal Mat2Axi_entry67_U0_cols_out2_write : STD_LOGIC;
    ...
    signal addrbound_U0_return_r : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal Mat2Axi_Block_split13_proc_U0_ap_return : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_channel_done_axibound_V : STD_LOGIC;
    signal axibound_V_full_n : STD_LOGIC;
    signal Mat2AxiStream_U0_dst_mat_422_read : STD_LOGIC;
    ...
    signal AxiStream2Axi_U0_m_axi_gmem2_WDATA : STD_LOGIC_VECTOR (63 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem2_WSTRB : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal rows_c10_dout : STD_LOGIC_VECTOR (15 downto 0);
    ...
    component canny_accel_Mat2Axi_entry67 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        cols_out2_din : OUT STD_LOGIC_VECTOR (10 downto 0);
        cols_out2_full_n : IN STD_LOGIC;
        cols_out2_write : OUT STD_LOGIC );
    end component;


    component canny_accel_addrbound IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component canny_accel_Mat2Axi_Block_split13_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        axibound_V_1 : IN STD_LOGIC_VECTOR (15 downto 0);
        ap_return : OUT STD_LOGIC_VECTOR (15 downto 0) );
    end component;


    component canny_accel_Mat2AxiStream IS
    port (
        dst_mat_422_dout : IN STD_LOGIC_VECTOR (63 downto 0);
        dst_mat_422_empty_n : IN STD_LOGIC;
        dst_mat_422_read : OUT STD_LOGIC;
    ...
    component canny_accel_AxiStream2Axi IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component canny_accel_fifo_w64_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component canny_accel_fifo_w16_d2_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component canny_accel_fifo_w11_d2_S_x0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component canny_accel_fifo_w64_d2_S_x0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component canny_accel_start_for_addrbound_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component canny_accel_start_for_Mat2AxiStream_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    Mat2Axi_entry67_U0 : component canny_accel_Mat2Axi_entry67
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    addrbound_U0 : component canny_accel_addrbound
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Mat2Axi_Block_split13_proc_U0 : component canny_accel_Mat2Axi_Block_split13_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Mat2AxiStream_U0 : component canny_accel_Mat2AxiStream
    port map (
    ...
    AxiStream2Axi_U0 : component canny_accel_AxiStream2Axi
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    dout_c_U : component canny_accel_fifo_w64_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    rows_c_U : component canny_accel_fifo_w16_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    rows_c10_U : component canny_accel_fifo_w16_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    cols_c_U : component canny_accel_fifo_w11_d2_S_x0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    cols_c11_U : component canny_accel_fifo_w11_d2_S_x0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    p_channel_U : component canny_accel_fifo_w16_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    axibound_V_U : component canny_accel_fifo_w16_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ldata_U : component canny_accel_fifo_w64_d2_S_x0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_addrbound_U0_U : component canny_accel_start_for_addrbound_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Mat2AxiStream_U0_U : component canny_accel_start_for_Mat2AxiStream_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    Mat2Axi_entry67_U0_ap_continue <= ap_const_logic_1;
    Mat2Axi_entry67_U0_ap_start <= ap_start;
    Mat2Axi_entry67_U0_start_full_n <= (start_for_addrbound_U0_full_n and start_for_Mat2AxiStream_U0_full_n);
    ...
    ap_done <= AxiStream2Axi_U0_ap_done;
    ap_idle <= ((axibound_V_empty_n xor ap_const_logic_1) and (p_channel_empty_n xor ap_const_logic_1) and addrbound_U0_ap_idle and Mat2Axi_entry67_U0_ap_idle and Mat2Axi_Block_split13_proc_U0_ap_idle and Mat2AxiStream_U0_ap_idle and AxiStream2Axi_U0_ap_idle);
    ap_ready <= Mat2Axi_entry67_U0_ap_ready;
    ap_sync_continue <= ap_continue;
    ap_sync_done <= AxiStream2Axi_U0_ap_done;
    ap_sync_ready <= Mat2Axi_entry67_U0_ap_ready;
    dst_mat_422_read <= Mat2AxiStream_U0_dst_mat_422_read;
