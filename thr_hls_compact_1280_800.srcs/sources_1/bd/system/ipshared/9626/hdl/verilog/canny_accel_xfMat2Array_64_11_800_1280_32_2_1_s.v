...
module canny_accel_xfMat2Array_64_11_800_1280_32_2_1_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    dstPtr_blk_n;
reg   [63:0] dstPtr_read_reg_80;
wire   [15:0] trunc_ln1557_fu_75_p1;
reg   [15:0] trunc_ln1557_reg_85;
reg   [10:0] srcMat_cols_read_reg_90;
wire    grp_Mat2Axi_fu_62_dst_mat_422_read;
...
wire   [63:0] grp_Mat2Axi_fu_62_m_axi_gmem2_WDATA;
wire   [7:0] grp_Mat2Axi_fu_62_m_axi_gmem2_WSTRB;
...
canny_accel_Mat2Axi grp_Mat2Axi_fu_62(
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((1'b1 == ap_CS_fsm_state2) & (ap_sync_grp_Mat2Axi_fu_62_ap_ready == 1'b0)) | (~((dstPtr_empty_n == 1'b0) | (srcMat_cols_empty_n == 1'b0) | (srcMat_rows_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1)))) begin
...
always @ (*) begin
    ap_block_state1_ignore_call11 = ((dstPtr_empty_n == 1'b0) | (srcMat_cols_empty_n == 1'b0) | (srcMat_rows_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1));
end

always @ (*) begin
    ap_block_state2_on_subcall_done = ((ap_sync_grp_Mat2Axi_fu_62_ap_ready & ap_sync_grp_Mat2Axi_fu_62_ap_done) == 1'b0);
end
...
assign trunc_ln1557_fu_75_p1 = srcMat_rows_dout[15:0];

endmodule //canny_accel_xfMat2Array_64_11_800_1280_32_2_1_s
