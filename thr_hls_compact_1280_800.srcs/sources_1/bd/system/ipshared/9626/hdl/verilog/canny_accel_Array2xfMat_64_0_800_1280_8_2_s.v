...
module canny_accel_Array2xfMat_64_0_800_1280_8_2_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [63:0] srcPtr_read_reg_93;
reg   [31:0] dstMat_rows_read_reg_98;
reg   [31:0] dstMat_cols_read_reg_103;
...
wire   [63:0] grp_Axi2Mat_fu_82_m_axi_gmem1_WDATA;
wire   [7:0] grp_Axi2Mat_fu_82_m_axi_gmem1_WSTRB;
...
wire   [63:0] grp_Axi2Mat_fu_82_in_mat_421_din;
wire    grp_Axi2Mat_fu_82_in_mat_421_write;
...
canny_accel_Axi2Mat grp_Axi2Mat_fu_82(
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state2) | ((1'b1 == ap_CS_fsm_state3) & (ap_sync_grp_Axi2Mat_fu_82_ap_ready == 1'b0)))) begin
...
always @ (*) begin
    if ((~((dstMat_cols_empty_n == 1'b0) | (dstMat_rows_empty_n == 1'b0) | (ap_start == 1'b0) | (srcPtr_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (dstMat_cols_out_full_n == 1'b0) | (dstMat_rows_out_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    ap_block_state1 = ((dstMat_cols_empty_n == 1'b0) | (dstMat_rows_empty_n == 1'b0) | (ap_start == 1'b0) | (srcPtr_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (dstMat_cols_out_full_n == 1'b0) | (dstMat_rows_out_full_n == 1'b0));
end

always @ (*) begin
    ap_block_state3_on_subcall_done = ((ap_sync_grp_Axi2Mat_fu_82_ap_ready & ap_sync_grp_Axi2Mat_fu_82_ap_done) == 1'b0);
end
...
assign in_mat_421_din = grp_Axi2Mat_fu_82_in_mat_421_din;
...
endmodule //canny_accel_Array2xfMat_64_0_800_1280_8_2_s
