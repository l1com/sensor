...
################################################################
# This is a generated script based on design: bd_4223
#
...
proc create_hier_cell_s07_nodes { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_s07_nodes() - Empty argument(s)!"}
     return
  }
  ...
  # Create port connections
  connect_bd_net -net m_sc_clk_1 [get_bd_pins m_sc_clk] [get_bd_pins s07_ar_node/m_sc_aclk] [get_bd_pins s07_aw_node/m_sc_aclk] [get_bd_pins s07_b_node/s_sc_aclk] [get_bd_pins s07_r_node/s_sc_aclk] [get_bd_pins s07_w_node/m_sc_aclk]
  connect_bd_net -net m_sc_resetn_1 [get_bd_pins m_sc_resetn] [get_bd_pins s07_ar_node/m_sc_aresetn] [get_bd_pins s07_aw_node/m_sc_aresetn] [get_bd_pins s07_b_node/s_sc_aresetn] [get_bd_pins s07_r_node/s_sc_aresetn] [get_bd_pins s07_w_node/m_sc_aresetn]
  connect_bd_net -net s_sc_clk_1 [get_bd_pins s_sc_clk] [get_bd_pins s07_ar_node/s_sc_aclk] [get_bd_pins s07_aw_node/s_sc_aclk] [get_bd_pins s07_b_node/m_sc_aclk] [get_bd_pins s07_r_node/m_sc_aclk] [get_bd_pins s07_w_node/s_sc_aclk]
  connect_bd_net -net s_sc_resetn_1 [get_bd_pins s_sc_resetn] [get_bd_pins s07_ar_node/s_sc_aresetn] [get_bd_pins s07_aw_node/s_sc_aresetn] [get_bd_pins s07_b_node/m_sc_aresetn] [get_bd_pins s07_r_node/m_sc_aresetn] [get_bd_pins s07_w_node/s_sc_aresetn]
...
proc create_hier_cell_s07_entry_pipeline { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_s07_entry_pipeline() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_s06_nodes { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_s06_nodes() - Empty argument(s)!"}
     return
  }
  ...
  # Create port connections
  connect_bd_net -net m_sc_clk_1 [get_bd_pins m_sc_clk] [get_bd_pins s06_ar_node/m_sc_aclk] [get_bd_pins s06_aw_node/m_sc_aclk] [get_bd_pins s06_b_node/s_sc_aclk] [get_bd_pins s06_r_node/s_sc_aclk] [get_bd_pins s06_w_node/m_sc_aclk]
  connect_bd_net -net m_sc_resetn_1 [get_bd_pins m_sc_resetn] [get_bd_pins s06_ar_node/m_sc_aresetn] [get_bd_pins s06_aw_node/m_sc_aresetn] [get_bd_pins s06_b_node/s_sc_aresetn] [get_bd_pins s06_r_node/s_sc_aresetn] [get_bd_pins s06_w_node/m_sc_aresetn]
  connect_bd_net -net s_sc_clk_1 [get_bd_pins s_sc_clk] [get_bd_pins s06_ar_node/s_sc_aclk] [get_bd_pins s06_aw_node/s_sc_aclk] [get_bd_pins s06_b_node/m_sc_aclk] [get_bd_pins s06_r_node/m_sc_aclk] [get_bd_pins s06_w_node/s_sc_aclk]
  connect_bd_net -net s_sc_resetn_1 [get_bd_pins s_sc_resetn] [get_bd_pins s06_ar_node/s_sc_aresetn] [get_bd_pins s06_aw_node/s_sc_aresetn] [get_bd_pins s06_b_node/m_sc_aresetn] [get_bd_pins s06_r_node/m_sc_aresetn] [get_bd_pins s06_w_node/s_sc_aresetn]
...
proc create_hier_cell_s06_entry_pipeline { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_s06_entry_pipeline() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_s05_nodes { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_s05_nodes() - Empty argument(s)!"}
     return
  }
  ...
  # Create port connections
  connect_bd_net -net m_sc_clk_1 [get_bd_pins m_sc_clk] [get_bd_pins s05_ar_node/m_sc_aclk] [get_bd_pins s05_aw_node/m_sc_aclk] [get_bd_pins s05_b_node/s_sc_aclk] [get_bd_pins s05_r_node/s_sc_aclk] [get_bd_pins s05_w_node/m_sc_aclk]
  connect_bd_net -net m_sc_resetn_1 [get_bd_pins m_sc_resetn] [get_bd_pins s05_ar_node/m_sc_aresetn] [get_bd_pins s05_aw_node/m_sc_aresetn] [get_bd_pins s05_b_node/s_sc_aresetn] [get_bd_pins s05_r_node/s_sc_aresetn] [get_bd_pins s05_w_node/m_sc_aresetn]
  connect_bd_net -net s_sc_clk_1 [get_bd_pins s_sc_clk] [get_bd_pins s05_ar_node/s_sc_aclk] [get_bd_pins s05_aw_node/s_sc_aclk] [get_bd_pins s05_b_node/m_sc_aclk] [get_bd_pins s05_r_node/m_sc_aclk] [get_bd_pins s05_w_node/s_sc_aclk]
  connect_bd_net -net s_sc_resetn_1 [get_bd_pins s_sc_resetn] [get_bd_pins s05_ar_node/s_sc_aresetn] [get_bd_pins s05_aw_node/s_sc_aresetn] [get_bd_pins s05_b_node/m_sc_aresetn] [get_bd_pins s05_r_node/m_sc_aresetn] [get_bd_pins s05_w_node/s_sc_aresetn]
...
proc create_hier_cell_s05_entry_pipeline { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_s05_entry_pipeline() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_m00_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SSC001_ROUTE {0b00000000} \
   CONFIG.SSC002_ROUTE {0b00000000} \
   CONFIG.SSC003_ROUTE {0b00000000} \
   CONFIG.SSC004_ROUTE {0b00010000} \
   CONFIG.SSC005_ROUTE {0b00100000} \
   CONFIG.SSC006_ROUTE {0b01000000} \
   CONFIG.SSC007_ROUTE {0b10000000} \
   CONFIG.SSC008_ROUTE {0b00000001} \
   CONFIG.SSC009_ROUTE {0b00000010} \
   CONFIG.SSC010_ROUTE {0b00000100} \
...
proc create_hier_cell_clk_map { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net clk_map_aclk1_net [get_bd_pins S04_ACLK] [get_bd_pins S05_ACLK] [get_bd_pins S06_ACLK] [get_bd_pins S07_ACLK] [get_bd_pins aclk1] [get_bd_pins psr0/slowest_sync_clk] [get_bd_pins psr_aclk1/slowest_sync_clk]
  ...
  connect_bd_net -net psr_aclk1_interconnect_aresetn [get_bd_pins S04_ARESETN] [get_bd_pins S05_ARESETN] [get_bd_pins S06_ARESETN] [get_bd_pins S07_ARESETN] [get_bd_pins psr_aclk1/interconnect_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {S04_AXI:S05_AXI:S06_AXI:S07_AXI} \
 ] $aclk1
  ...
  connect_bd_intf_net -intf_net S_SC_AR_1 [get_bd_intf_pins s04_axi2sc/M_SC_AR] [get_bd_intf_pins s04_nodes/S_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_2 [get_bd_intf_pins s05_axi2sc/M_SC_AR] [get_bd_intf_pins s05_nodes/S_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_3 [get_bd_intf_pins s06_axi2sc/M_SC_AR] [get_bd_intf_pins s06_nodes/S_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_4 [get_bd_intf_pins s07_axi2sc/M_SC_AR] [get_bd_intf_pins s07_nodes/S_SC_AR]
  ...
  connect_bd_intf_net -intf_net S_SC_AW_4 [get_bd_intf_pins s04_axi2sc/M_SC_AW] [get_bd_intf_pins s04_nodes/S_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_5 [get_bd_intf_pins s05_axi2sc/M_SC_AW] [get_bd_intf_pins s05_nodes/S_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_6 [get_bd_intf_pins s06_axi2sc/M_SC_AW] [get_bd_intf_pins s06_nodes/S_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_7 [get_bd_intf_pins s07_axi2sc/M_SC_AW] [get_bd_intf_pins s07_nodes/S_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_8 [get_bd_intf_pins m00_nodes/S_SC_AW] [get_bd_intf_pins switchboards/M00_SC_AW]
  ...
  connect_bd_intf_net -intf_net S_SC_B_4 [get_bd_intf_pins s04_nodes/S_SC_B] [get_bd_intf_pins switchboards/M04_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_5 [get_bd_intf_pins s05_nodes/S_SC_B] [get_bd_intf_pins switchboards/M05_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_6 [get_bd_intf_pins s06_nodes/S_SC_B] [get_bd_intf_pins switchboards/M06_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_7 [get_bd_intf_pins s07_nodes/S_SC_B] [get_bd_intf_pins switchboards/M07_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_8 [get_bd_intf_pins m00_nodes/S_SC_B] [get_bd_intf_pins m00_sc2axi/M_SC_B]
  connect_bd_intf_net -intf_net S_SC_R_1 [get_bd_intf_pins s04_nodes/S_SC_R] [get_bd_intf_pins switchboards/M04_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_2 [get_bd_intf_pins s05_nodes/S_SC_R] [get_bd_intf_pins switchboards/M05_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_3 [get_bd_intf_pins s06_nodes/S_SC_R] [get_bd_intf_pins switchboards/M06_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_4 [get_bd_intf_pins s07_nodes/S_SC_R] [get_bd_intf_pins switchboards/M07_SC_R]
  ...
  connect_bd_intf_net -intf_net S_SC_W_4 [get_bd_intf_pins s04_axi2sc/M_SC_W] [get_bd_intf_pins s04_nodes/S_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_5 [get_bd_intf_pins s05_axi2sc/M_SC_W] [get_bd_intf_pins s05_nodes/S_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_6 [get_bd_intf_pins s06_axi2sc/M_SC_W] [get_bd_intf_pins s06_nodes/S_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_7 [get_bd_intf_pins s07_axi2sc/M_SC_W] [get_bd_intf_pins s07_nodes/S_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_8 [get_bd_intf_pins m00_nodes/S_SC_W] [get_bd_intf_pins switchboards/M00_SC_W]
  ...
  connect_bd_net -net aclk_4 [get_bd_pins clk_map/S04_ACLK] [get_bd_pins s04_axi2sc/aclk] [get_bd_pins s04_entry_pipeline/aclk] [get_bd_pins s04_nodes/s_sc_clk]
  connect_bd_net -net aclk_5 [get_bd_pins clk_map/S05_ACLK] [get_bd_pins s05_axi2sc/aclk] [get_bd_pins s05_entry_pipeline/aclk] [get_bd_pins s05_nodes/s_sc_clk]
  connect_bd_net -net aclk_6 [get_bd_pins clk_map/S06_ACLK] [get_bd_pins s06_axi2sc/aclk] [get_bd_pins s06_entry_pipeline/aclk] [get_bd_pins s06_nodes/s_sc_clk]
  connect_bd_net -net aclk_7 [get_bd_pins clk_map/S07_ACLK] [get_bd_pins s07_axi2sc/aclk] [get_bd_pins s07_entry_pipeline/aclk] [get_bd_pins s07_nodes/s_sc_clk]
  ...
  connect_bd_net -net aresetn_5 [get_bd_pins clk_map/S04_ARESETN] [get_bd_pins s04_entry_pipeline/aresetn] [get_bd_pins s04_nodes/s_sc_resetn]
  connect_bd_net -net aresetn_6 [get_bd_pins clk_map/S05_ARESETN] [get_bd_pins s05_entry_pipeline/aresetn] [get_bd_pins s05_nodes/s_sc_resetn]
  connect_bd_net -net aresetn_7 [get_bd_pins clk_map/S06_ARESETN] [get_bd_pins s06_entry_pipeline/aresetn] [get_bd_pins s06_nodes/s_sc_resetn]
  connect_bd_net -net aresetn_8 [get_bd_pins clk_map/S07_ARESETN] [get_bd_pins s07_entry_pipeline/aresetn] [get_bd_pins s07_nodes/s_sc_resetn]
  ...
  connect_bd_net -net swbd_aclk_net [get_bd_pins clk_map/swbd_aclk] [get_bd_pins m00_nodes/s_axi_aclk] [get_bd_pins s00_nodes/m_sc_clk] [get_bd_pins s01_nodes/m_sc_clk] [get_bd_pins s02_nodes/m_sc_clk] [get_bd_pins s04_nodes/m_sc_clk] [get_bd_pins s05_nodes/m_sc_clk] [get_bd_pins s06_nodes/m_sc_clk] [get_bd_pins s07_nodes/m_sc_clk] [get_bd_pins switchboards/aclk]
  connect_bd_net -net swbd_aresetn_net [get_bd_pins clk_map/swbd_aresetn] [get_bd_pins m00_nodes/s_axi_aresetn] [get_bd_pins s00_nodes/m_sc_resetn] [get_bd_pins s01_nodes/m_sc_resetn] [get_bd_pins s02_nodes/m_sc_resetn] [get_bd_pins s04_nodes/m_sc_resetn] [get_bd_pins s05_nodes/m_sc_resetn] [get_bd_pins s06_nodes/m_sc_resetn] [get_bd_pins s07_nodes/m_sc_resetn] [get_bd_pins switchboards/aresetn]
